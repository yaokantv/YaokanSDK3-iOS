...
default:
    ...
    call: function(b, a, c) {
        ...
        a = JSON.stringify(a);
        if (window._yaokan) e = _yaokan.call(b, a);
        else if (window._dswk || -1 != navigator.userAgent.indexOf("_yaokan")) e = prompt("_yaokan=" + b, a);
    ...
    deviceSmartConfig: function(b,c){
        this.call("deviceSmartConfig",b,c)
    },
    
    saveRemoteControl: function(b,c){
        this.call("saveRemoteControl",b,c)
    },
    
    saveRCLocal: function(b,c){
        this.call("saveRemoteControlLocal",b,c)
    },
    
    sendRCLocal: function(b,c){
        this.call("sendRemoteControlLocal",b,c)
    },
    
    
    getRemoteControlList: function(c){
        this.call("getRemoteControlList",c)
    },
    deviceStatus: function(b,c){
            this.call("deviceStatus",b,c)
    },
    deviceInfo: function(b,c){
            this.call("deviceInfo",b,c)
    },
    sendDeviceCmd: function(b,c){
            this.call("sendDeviceCmd",b,c)
    },
    getDeviceList: function(c){
            this.call("getDeviceList",c)
    },
    
//    saveRemoteControl:function (c) {
//        this.call("saveRemoteControl",c)
//    },
